<%@ Page Title="" Language="VB" MasterPageFile="~/Principal.master" AutoEventWireup="false" CodeFile="NtsP.aspx.vb" Inherits="NtsP" %>
    ...
    <td>
      <table cellpadding="1" cellspacing="1" border="0">
        <tr>
          <td>County:</td>
          <td>
          <asp:ListBox ID="ddlCounty" runat="server" SelectionMode="Single" Height="100px"
              DataSourceID="sourceCounty" DataTextField="Name" DataValueField="IdCounty"></asp:ListBox></td>
    ...
    <td>
      <table cellpadding="1" cellspacing="1" border="0">
        <tr>
          ...
          <td style="width: 20px"></td>
          <td>Trustor/Trustee/Owner/Benefry:</td>
...
<div id="divGridPrincipal" style="overflow:scroll; width:900%; overflow:hidden;">
</div>
      <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
        BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" 
        CellPadding="3" DataKeyNames="IdNts" DataSourceID="LinqDataSource1" 
...
<RowStyle Wrap="False"></RowStyle>
        <Columns>
          ...
          <asp:BoundField DataField="IdNts" HeaderText="IdNts" InsertVisible="False" 
            ReadOnly="True" SortExpression="IdNts" />
          ...
          <asp:BoundField DataField="T_S_NO" HeaderText="SALE NO." 
            SortExpression="T_S_NO" />
          <asp:BoundField DataField="LST" HeaderText="LST" SortExpression="LST" />
          <asp:BoundField DataField="ADDRESS" HeaderText="ADDRESS" 
            SortExpression="ADDRESS" />
          <asp:BoundField DataField="ST_CITYSTATE" HeaderText="CITY" SortExpression="ST_CITYSTATE" />
          ...
          <asp:TemplateField HeaderText="T_PHONE" SortExpression="T_PHONE">
            <HeaderTemplate>
                <asp:LinkButton ID="LinkButtonT_PHONE" runat="server" Text="T_PHONE" ForeColor="White" 
                CommandName="Sort" CommandArgument="T_PHONE"></asp:LinkButton>
            </HeaderTemplate>
            <ItemTemplate>
              <igtxt:WebMaskEdit ID="MaskT_PHONE" runat="server" 
                  InputMask="(###) ###-####" Width="100px" Height="15px" BorderStyle="None" ReadOnly="true"
                  Font-Size="10px" Value='<%# Replace(Replace(Eval("T_PHONE"), " ", ""), "-", "") %>' CssClass="TextGrid"></igtxt:WebMaskEdit>
            </ItemTemplate>
          </asp:TemplateField>
          ...
          <asp:BoundField DataField="TX_YR" HeaderText="TX_YR" SortExpression="TX_YR" />
          <asp:BoundField DataField="PRCHS_DATE" HeaderText="PRCHS_DATE" 
            SortExpression="PRCHS_DATE" DataFormatString="{0:MM/dd/yyyy}" />
          <asp:BoundField DataField="AMOUNT" HeaderText="MIN BID" 
            SortExpression="AMOUNT" />
          <asp:BoundField DataField="TD1_A" HeaderText="TD1_A" SortExpression="TD1_A" />
          <asp:BoundField DataField="TD1" HeaderText="TD1" SortExpression="TD1" />
          <asp:BoundField DataField="TD1_D" HeaderText="TD1_D" SortExpression="TD1_D" DataFormatString="{0:MM/dd/yyyy}" />
          <asp:BoundField DataField="TD2_A" HeaderText="TD2_A" SortExpression="TD2_A" />
          <asp:BoundField DataField="TD2" HeaderText="TD2" SortExpression="TD2" />
          <asp:BoundField DataField="TD2_D" HeaderText="TD2_D" SortExpression="TD2_D" DataFormatString="{0:MM/dd/yyyy}" />
          ...
          <asp:BoundField DataField="NTS" HeaderText="NTS" SortExpression="NTS" />
          ...
          <asp:BoundField DataField="NTS_REC_DT" HeaderText="NTS_REC_DT" 
            SortExpression="NTS_REC_DT" DataFormatString="{0:MM/dd/yyyy}" />
        </Columns>
...
<table cellpadding="1" cellspacing="1" border="0" title="more than 20 records per page can cause slow speed">
  <tr>
    <td style="white-space: nowrap;">
        ...
        <asp:Button ID="btnToNOD" runat="server" Text="To NOD" CssClass="ButtonNew" />
    ...
    <td><asp:TextBox ID="txtPageSize" runat="server" Width="25">20</asp:TextBox></td>
    ...
    <td style="width: 30px"></td>
    <td><input type="button" value="Add a New One" onclick="javascript:NtsEd(0)" class="ButtonNew" /></td>
    <td style="width: 30px"></td>
...
<asp:Panel ID="panelChk" runat="server" Visible="false">
  ...
  <asp:LinqDataSource ID="LinqDataSource1" runat="server" 
    ContextTypeName="DataClassesDataContext" TableName="NTs" OnSelecting="LinqDataSource1_Selecting" OrderBy="IdNts DESC" >
<%--      
