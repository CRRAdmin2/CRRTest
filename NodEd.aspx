<%@ Page Language="VB" AutoEventWireup="false" CodeFile="NodEd.aspx.vb" Inherits="NodEd" %>
...
<body bgcolor="#DDDDEE">
    ...
    <asp:HiddenField ID="hdnIdNod" runat="server" Value="0" />
                ...
                <td colspan="100%"><br />
                  <table cellpadding="2" cellspacing="0" border="0" class="boxIsland">
                    ...
                    <tr>
                      <td>House #</td>
                      <td>
                        <asp:TextBox ID="txtTrusteeHouseNumber" runat="server" Width="60px" MaxLength="10"></asp:TextBox>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        St Name <asp:TextBox ID="txtTrusteeStreetName" runat="server" Width="200px" MaxLength="50"></asp:TextBox>
                      </td>
                    </tr>
                    <tr>
                      <td>NBR</td>
                      <td>
                        <asp:TextBox ID="txtFD_TRUSTEE_SALE_NBR" runat="server" Width="180px" MaxLength="15"></asp:TextBox>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        Unit NBR <asp:TextBox ID="txtTrusteeUnitNBR" runat="server" Width="40px" MaxLength="5"></asp:TextBox>
                      </td>
                    </tr>
                    <tr>
                      <td>City</td>
          ...
          <td class="ColumnEd">
            ...
            <table cellpadding="1" cellspacing="0" border="0">
              <tr>
                ...
                <td>Del Amt</td>
                <td><asp:TextBox ID="txtDelAmt" runat="server" Width="120px"></asp:TextBox></td>
              </tr>
              <tr>
                <td>As Of</td>
                <td><uc1:DateControl ID="DateControlAsOf" runat="server" /></td>
                <td>Delinq</td>
                <td><uc1:DateControl ID="DateControlDelinq" runat="server" /></td>
              </tr>
              <tr>
                <td>NOD</td>
                <td><asp:TextBox ID="txtNOD" runat="server" Width="120px"></asp:TextBox></td>
                <td colspan="2"><uc1:DateControl ID="DateNOD" runat="server" ToolTip="NOD Recording Date" /></td>
              </tr>
              <tr>
                <td>NTS</td>
            ...
            <table cellpadding="2" cellspacing="0" border="0" class="boxIsland">
              ...
              <tr>
                <td>House #</td>
                <td><asp:TextBox ID="txtMailHouseNumber" runat="server" MaxLength="20"></asp:TextBox>
                  &nbsp;&nbsp;&nbsp;
    ...
    <asp:TextBox ID="txtOwner" runat="server" Width="300px" Visible="false"></asp:TextBox>
